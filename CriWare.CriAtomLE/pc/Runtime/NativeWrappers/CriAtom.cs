...
#pragma warning disable 0465
	...
	public static partial class CriAtom
	{
		...
		/// </para>
		/// <nativeinfo declaration="CriSint32 CRIAPI criAtom_CalculateWorkSize_WASAPI(const CriAtomConfig_WASAPI *config)"/>
		/// </remarks>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_Initialize_WASAPI(const CriAtomConfig_WASAPI *config, void *work, CriSint32 work_size)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.ConfigWASAPI"/>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_Finalize_WASAPI(void)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.InitializeWASAPI"/>
		...
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetDefaultDeviceRole_WASAPI(ERole role)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="CriBool CRIAPI criAtom_GetAudioClientMixFormat_WASAPI(WAVEFORMATEXTENSIBLE *format)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="CriBool CRIAPI criAtom_GetAudioClientIsFormatSupported_WASAPI(const WAVEFORMATEX *format)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetAudioClientShareMode_WASAPI(AUDCLNT_SHAREMODE mode)"/>
		/// </remarks>
		...
		/// 現在指定されている共有方式を取得します。 
		/// </para>
		/// <nativeinfo declaration="AUDCLNT_SHAREMODE CRIAPI criAtom_GetAudioClientShareMode_WASAPI(void)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetAudioClientFormat_WASAPI(const WAVEFORMATEX *format)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.SetAudioClientShareModeWASAPI"/>
		...
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetAudioClientBufferDuration_WASAPI(REFERENCE_TIME ref_time)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="IAudioClient* CRIAPI criAtom_GetAudioClient_WASAPI(void)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="CriBool CRIAPI criAtom_IsDeviceInvalidated_WASAPI(void)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetDeviceId_WASAPI(CriAtomSoundRendererType type, LPCWSTR device_id)"/>
		/// </remarks>
		...
		/// </list>
		/// </list>
		/// <nativeinfo declaration="CriBool CRIAPI criAtom_GetDeviceId_WASAPI(CriAtomSoundRendererType type, LPWSTR device_id, CriSint32 count, CriBool *is_default_device)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="CriSint32 CRIAPI criAtom_EnumAudioEndpoints_WASAPI(CriAtomAudioEndpointCbFunc_WASAPI callback, void *object)"/>
		/// </remarks>
		...
		/// 第 2 引数（ object ）にセットした値は、コールバック関数の引数として渡されます。
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetDeviceUpdateCallback_WASAPI(CriAtomDeviceUpdateCbFunc_WASAPI callback, void *object)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.AudioEndpointCbFuncWASAPI"/>
		...
		/// 本関数はライブラリ初期化前に使用する必要があります。
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetSpatialAudioEnabled_WASAPI(CriAtomSoundRendererType type, CriBool sw)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="CriBool CRIAPI criAtom_IsSpatialAudioEnabled_WASAPI(CriAtomSoundRendererType type)"/>
		/// </remarks>
		...
		/// </para>
		/// <nativeinfo declaration="CriSint32 CRIAPI criAtom_CalculateWorkSize_PC(const CriAtomConfig_PC *config)"/>
		/// </remarks>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_Initialize_PC(const CriAtomConfig_PC *config, void *work, CriSint32 work_size)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.ConfigPC"/>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_Finalize_PC(void)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.InitializePC"/>
		...
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetThreadPriority_PC(int prio)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.InitializePC"/>
		...
		///  （エラーコールバックが発生します。）
		/// </para>
		/// <nativeinfo declaration="int CRIAPI criAtom_GetThreadPriority_PC(void)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.InitializePC"/>
		...
		///  すでにCRI File SystemライブラリのAPIでサーバー処理スレッドの設定を変更している場合 本関数により設定が上書きされますのでご注意ください。
		/// </para>
		/// <nativeinfo declaration="void CRIAPI criAtom_SetThreadAffinityMask_PC(DWORD_PTR mask)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.InitializePC"/>
		...
		///  （エラーコールバックが発生します。）
		/// </para>
		/// <nativeinfo declaration="DWORD_PTR CRIAPI criAtom_GetThreadAffinityMask_PC(void)"/>
		/// </remarks>
		/// <seealso cref="CriAtom.InitializePC"/>
