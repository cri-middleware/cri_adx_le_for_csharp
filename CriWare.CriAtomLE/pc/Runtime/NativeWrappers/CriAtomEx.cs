...
#pragma warning disable 0465
	...
	public static partial class CriAtomEx
	{
		...
		/// </para>
		/// <nativeinfo declaration="CriSint32 criAtomEx_CalculateWorkSize_PC(const CriAtomExConfig_PC *config)"/>
		/// </remarks>
		/// <seealso cref="CriAtomEx.ConfigPC"/>
		/// <seealso cref="CriAtomEx.InitializePC"/>
		public static unsafe Int32 CalculateWorkSizePC(in CriAtomEx.ConfigPC config)
		{
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void criAtomEx_Initialize_PC(const CriAtomExConfig_PC *config, void *work, CriSint32 work_size)"/>
		/// </remarks>
		/// <seealso cref="CriAtomEx.ConfigPC"/>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void criAtomEx_Finalize_PC(void)"/>
		/// </remarks>
		/// <seealso cref="CriAtomEx.InitializePC"/>
