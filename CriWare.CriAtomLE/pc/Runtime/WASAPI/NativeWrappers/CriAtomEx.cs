...
#pragma warning disable 0465
	...
	public static partial class CriAtomEx
	{
		...
		/// </para>
		/// <nativeinfo declaration="CriSint32 criAtomEx_CalculateWorkSize_WASAPI(const CriAtomExConfig_WASAPI *config)"/>
		/// </remarks>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void criAtomEx_Initialize_WASAPI(const CriAtomExConfig_WASAPI *config, void *work, CriSint32 work_size)"/>
		/// </remarks>
		/// <seealso cref="CriAtomEx.ConfigWASAPI"/>
		...
		/// </list>
		/// </para>
		/// <nativeinfo declaration="void criAtomEx_Finalize_WASAPI(void)"/>
		/// </remarks>
		/// <seealso cref="CriAtomEx.InitializeWASAPI"/>
